...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
              <div class="row">
                <h1 class="text-center">RECIBOS DE PAGO</h1>
              </div>
              <div class="recibos-pago" style="margin-top:50px;">
                <a href="subir_pagos.php" class="btn btn-primary btn-lg btn-block">10000001364</a>
                <a href="subir_pagos.php" class="btn btn-primary btn-lg btn-block">10000001364</a>
                <a href="subir_pagos.php" class="btn btn-primary btn-lg btn-block">10000001364</a>
                <a href="subir_pagos.php" class="btn btn-primary btn-lg btn-block">10000001364</a>
                <a href="subir_pagos.php" class="btn btn-primary btn-lg btn-block">10000001364</a>
